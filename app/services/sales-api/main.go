...
import (
	...
	"github.com/startdusk/service/app/services/sales-api/handlers"
...
func run(log *zap.SugaredLogger) error {
	...
	cfg := struct {
		...
		Auth struct {
			...
			ActiveKID  string `conf:"default:d3ec7ff9-69c4-4708-affc-510193cba055"`
		}
		DB struct {
	...
	// Construct the mux for the dubug calls.
